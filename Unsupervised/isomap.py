...
samples = []
IMAGES = "images.csv" # This was from my SURF, replace with csv containing all the file paths for images 
FEATURES = "reduced.csv" #This is for image features instead of raw pixel data. If you dont have a csv of image features, discard 
colors = []
discard = []
